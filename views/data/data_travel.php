<div class="text-right mb-2" style="margin-top: -16px;">
    <a href="print" target="_blank" class="btn btn-warning btn-sm text-white">Cetak Laporan</a>
</div>
        ...
        ?>
                <tr>
                    ...
                    <td>
                        ...
                        EDIT</a>
                        <a href="hapus-catatan/<?= $pd['0'] ?>" class="btn btn-danger btn-sm hapus-catatan">HAPUS</a>
                    </td>
                </tr>
        <?php
            }
